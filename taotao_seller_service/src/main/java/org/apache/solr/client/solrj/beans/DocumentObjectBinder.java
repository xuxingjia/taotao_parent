...
//                    if ("#default".equals(annotation.value()) || "".equals(annotation.value())) {
//                        // 如果注解为默认的 采用此属性的name来从solr中获取值
//                        if (field.getType() == BigDecimal.class) {
//                            field.set(obj, new BigDecimal(field.get(field.getName()).toString()));
//                        } else {
//                            field.set(obj, field.get(field.getName()));
//                        }
//                    } else {
//                        // 如果注解为不是默认的 采用此注解上的值来从solr中获取值
//                        field.set(obj, field.get(annotation.value()));
//                    }
//                }
//            }
            ...
            if (field.dynamicFieldNamePatternMatcher != null &&
                ...
                if (field.child != null) {
                    ...
                    if (field.get(obj) instanceof BigDecimal){
                        doc.setField(field.name, Long.valueOf(field.get(obj).toString()));
                    }else {
